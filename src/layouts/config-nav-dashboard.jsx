...
export const navData = [
   ...
   */
  {
    ...
    items: [
      { title: 'Laboratory Seatwork 1', path: paths.dashboard.ls1, icon: ICONS.dashboard },
      { title: 'Laboratory Seatwork 2', path: paths.dashboard.ls2, icon: ICONS.dashboard },
      { title: 'Laboratory Seatwork 3', path: paths.dashboard.ls3, icon: ICONS.dashboard },
      { title: 'Laboratory Seatwork 4', path: paths.dashboard.ls4, icon: ICONS.dashboard },
      { title: 'Long Quiz', path: paths.dashboard.lq, icon: ICONS.dashboard },
    ],
  },
  {
    ...
    items: [
      ...
      { title: 'Final Exam', path: paths.dashboard.finalExam, icon: ICONS.booking },
    ],
  },
];